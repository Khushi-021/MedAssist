...
def product_submit(request):
    try:
        ...
        S=open("C:/Users/khush/PycharmProjects/medassist_ecom/assets/"+producticon.name,'wb')
...
def edit_producticon(request):
        try:
            ...
            print(q)
            f = open("C:/Users/khush/PycharmProjects/medassist_ecom/assets/" + producticon.name, 'wb')
